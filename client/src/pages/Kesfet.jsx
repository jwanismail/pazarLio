...
const Kesfet = () => {
  ...
  return (
    <>
      <Helmet>
        <title>İlanları Keşfet - PazarLio | İkinci El Alışveriş Platformu</title>
        <meta name="description" content="PazarLio'da binlerce ikinci el ürün arasından istediğinizi bulun. Yurt öğrencileri için özel kategoriler, güvenli alışveriş ve hızlı iletişim." />
        <meta name="keywords" content="ikinci el ilanlar, yurt öğrenci alışveriş, ikinci el ürünler, satılık eşya, alım satım, öğrenci pazarı" />
        ...
        <meta property="og:title" content="İlanları Keşfet - PazarLio | İkinci El Alışveriş Platformu" />
        <meta property="og:description" content="PazarLio'da binlerce ikinci el ürün arasından istediğinizi bulun. Yurt öğrencileri için özel kategoriler, güvenli alışveriş ve hızlı iletişim." />
        ...
        <meta property="twitter:title" content="İlanları Keşfet - PazarLio | İkinci El Alışveriş Platformu" />
        <meta property="twitter:description" content="PazarLio'da binlerce ikinci el ürün arasından istediğinizi bulun. Yurt öğrencileri için özel kategoriler, güvenli alışveriş ve hızlı iletişim." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "PazarLio'da satışa çıkarılan ikinci el ürünler",
