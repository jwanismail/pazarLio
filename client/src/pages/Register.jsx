...
import { FaUser, FaEnvelope, FaLock, FaPhone, FaUserPlus, FaMobile, FaKey, FaCheckCircle, FaTimesCircle } from 'react-icons/fa'
...
const Register = () => {
  ...
  const handleSendVerificationCode = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5002/kayit-dogrulama-kodu-gonder', {
        method: 'POST',
        headers: {
  ...
  const handleVerifyAndRegister = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5002/kayit-dogrulama', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  return (
    <>
      <Helmet>
        <title>Kayıt Ol - PazarLio | Ücretsiz Hesap Oluştur</title>
        <meta name="description" content="PazarLio'ya ücretsiz kayıt olun ve güvenli ikinci el alışveriş deneyimini yaşayın. Telefon doğrulama ile güvenli kayıt." />
        <meta name="keywords" content="kayıt ol, üye ol, hesap oluştur, PazarLio kayıt, ücretsiz kayıt, ikinci el alışveriş" />
        ...
        <meta property="og:url" content="https://pazarlio.com/register" />
        <meta property="og:title" content="Kayıt Ol - PazarLio | Ücretsiz Hesap Oluştur" />
        <meta property="og:description" content="PazarLio'ya ücretsiz kayıt olun ve güvenli ikinci el alışveriş deneyimini yaşayın. Telefon doğrulama ile güvenli kayıt." />
        <meta property="og:image" content="https://pazarlio.com/register-og-image.jpg" />
        <meta property="og:site_name" content="PazarLio" />
        <meta property="og:locale" content="tr_TR" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://pazarlio.com/register" />
        <meta property="twitter:title" content="Kayıt Ol - PazarLio | Ücretsiz Hesap Oluştur" />
        <meta property="twitter:description" content="PazarLio'ya ücretsiz kayıt olun ve güvenli ikinci el alışveriş deneyimini yaşayın. Telefon doğrulama ile güvenli kayıt." />
        <meta property="twitter:image" content="https://pazarlio.com/register-twitter-image.jpg" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://pazarlio.com/register" />
      </Helmet>
