            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4 py-4 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center text-gray-600 dark:text-gray-300">
                  ...
                  <span className="text-sm">{ilan.konum}</span>
                </div>
                <div className="flex items-center text-gray-600 dark:text-gray-300">
                  <FaCalendarAlt className="mr-2 text-blue-500" />
                  <span className="text-sm">{new Date(ilan.tarih).toLocaleDateString('tr-TR')}</span>
                </div>
                <div className="flex items-center text-gray-600 dark:text-gray-300">
                  <FaUser className="mr-2 text-blue-500" />
                  <span className="text-sm">{ilan.kullaniciAdi}</span>
                </div>
                <div className="flex items-center text-gray-600 dark:text-gray-300">
