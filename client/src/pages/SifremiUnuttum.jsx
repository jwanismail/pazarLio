...
const SifremiUnuttum = () => {
  ...
  const handleSendResetCode = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5002/sifremi-unuttum', {
        method: 'POST',
        headers: {
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5002/sifre-sifirlama-dogrula', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSetNewPassword = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5002/yeni-sifre-belirle', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
