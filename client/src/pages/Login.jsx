...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Giriş Yap - PazarLio | Güvenli Giriş</title>
        <meta name="description" content="PazarLio hesabınıza güvenli giriş yapın. Şifre ile veya SMS doğrulama kodu ile giriş yapabilirsiniz." />
        <meta name="keywords" content="giriş yap, login, hesap girişi, PazarLio giriş, güvenli giriş" />
        ...
        <meta property="og:url" content="https://pazarlio.com/login" />
        <meta property="og:title" content="Giriş Yap - PazarLio | Güvenli Giriş" />
        <meta property="og:description" content="PazarLio hesabınıza güvenli giriş yapın. Şifre ile veya SMS doğrulama kodu ile giriş yapabilirsiniz." />
        <meta property="og:image" content="https://pazarlio.com/login-og-image.jpg" />
        <meta property="og:site_name" content="PazarLio" />
        <meta property="og:locale" content="tr_TR" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://pazarlio.com/login" />
        <meta property="twitter:title" content="Giriş Yap - PazarLio | Güvenli Giriş" />
        <meta property="twitter:description" content="PazarLio hesabınıza güvenli giriş yapın. Şifre ile veya SMS doğrulama kodu ile giriş yapabilirsiniz." />
        <meta property="twitter:image" content="https://pazarlio.com/login-twitter-image.jpg" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://pazarlio.com/login" />
      </Helmet>
